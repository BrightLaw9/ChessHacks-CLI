...
C_PUCT = 2.5 # 1.5                 # Exploration constant for UCB

# Network Configuration
INPUT_CHANNELS = 13          # Number of input planes (6 own + 6 opponent + 1 metadata)
RESIDUAL_BLOCKS = 8          # Number of ResNet blocks
HIDDEN_CHANNELS = 192        # Channels in hidden layers
...
EPOCHS = 10
GAMES_PER_CHECKPOINT = 5 # Number of batches before saving a checkpoint
...
MODEL_PATH = os.path.abspath(
	os.path.join(os.path.dirname(__file__), "models", "trained_model_test.pth")
)
